...
<input id="idevents" name="idevents" placeholder="ID" type="text" class="form-control" value="<?php echo set_value('idevents', $eventrecord[0]->idevents) ?>" />
 ...
 <div class="col-md-8">
<input id="eventname" name="eventname" placeholder="Title of Event"
type="text" class="form-control" value="<?php echo set_value('eventname', $eventrecord[0]->event_name); ?>" />
 ...
 <div class="col-md-8">
<input id="eventstartdate" name="eventstartdate" placeholder="Date"
type="text" class="form-control" value="<?php echo set_value('eventstartdate', @date('d-m-Y', @strtotime($eventrecord[0]->eventstartdate))); ?>" />
