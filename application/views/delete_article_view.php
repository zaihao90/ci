...
<div class="container">
 ...
 <td><?php echo $participant_list[$i]->event_name; ?></td>
 <td><?php echo $participant_list[$i]->participated_date; ?></td>
 <td><?php echo $participant_list[$i]->article; ?></td>
<td><a href="<?php echo base_url() .
"index.php/updateArticle/index/" . $participant_list[$i]->participant_no; ?>">Update</a></td>
<td><a href="<?php echo base_url() .
"index.php/deleteArticle/delete_article/" . $participant_list[$i]->participant_id; ?>">Delete</a></td>
 </tr>
 <?php } ?>
 </tbody>
 </table>
