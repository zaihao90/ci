						...
						<fieldset>
							...
							<div class="form-group">
								<div class="row colbox">
									...
									<div class="col-lg-8 col-sm-8">
										...
										class="form-control" value="<?php echo set_value('articletitle'); ?>" />
							...
							<div class="form-group">
								<div class="row colbox">
									...
									<div class="col-lg-8 col-sm-8">
										...
										class="form-control" style=" height:200px;text-align:top-left;padding: 20px;"value="<?php echo set_value('article'); ?>" />
							...
							<div class="form-group">
								<div class="col-sm-offset-4 col-lg-8 col-sm-8 text-left">
									...
									value="Cancel" />
									<INPUT Type="Button" VALUE="Back" id="btn_add" name="btn_add"  style="width: 70px; height: 35px; background-color:#58D68D;"onClick="history.go(-1);return true;">
									</div>
								</div>
							...
							<?php if(isset($_SESSION['createarticle'])){?>
							<div class="alert alert-success textcenter"><?php if(isset($_SESSION['createarticle'])){ echo $_SESSION['createarticle']; echo $hello; 
							}?></div> <?php } ?>
