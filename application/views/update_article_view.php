...
"participantform");
 ...
 <div class="col-md-8">
	<input id="participantno" name="participantno" placeholder="Participant no" type="text" disabled="disabled" class="form-control" value="<?php echo $participantrecord[0]->participant_id; ?>" />
 ...
 <div class="col-md-8">
	<input id="articletitle" name="articletitle" placeholder="Share your experience"
	type="text" class="form-control" value="<?php echo set_value('articletitle',
	$participantrecord[0]->articletitle); ?>" />
 ...
 <div class="col-md-8">
	<input id="article" name="article" placeholder="Share your experience"
 ...
 <div class="col-sm-offset-4 col-md-8 text-left">
	...
	value="Cancel" />
	<INPUT Type="Button" VALUE="Back" id="btn_add" name="btn_add"  style="width: 70px; height: 35px; background-color:#58D68D;"onClick="history.go(-2);return true;">
 </div>
 </div>
 </fieldset>
 <?php echo form_close(); ?>
